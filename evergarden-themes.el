    ...
    (cl-labels ((c (name) (cdr (assq name colors)))
      ...
      (append
       ...
       (list
        ...
        (cons 'show-paren-match (a (c 'orange) nil)))
       ...
       ;; is Title (cherry).
       (list
        (cons 'org-level-1 (a (c 'red) nil '(bold)))
        (cons 'org-level-2 (a (c 'orange) nil '(bold)))
        (cons 'org-level-3 (a (c 'yellow) nil '(bold)))
        (cons 'org-level-4 (a (c 'green) nil '(bold)))
        (cons 'org-level-5 (a (c 'aqua) nil '(bold)))
        (cons 'org-level-6 (a (c 'blue) nil '(bold)))
        (cons 'org-level-7 (a (c 'purple) nil '(bold)))
        (cons 'org-level-8 (a (c 'pink) nil '(bold)))
        (cons 'org-document-title (a (c 'cherry) nil '(bold)))
        (cons 'org-document-info (a (c 'subtext0) nil))
        (cons 'org-document-info-keyword (a (c 'overlay1) nil))
        (cons 'org-todo (a (c 'crust) (c 'aqua) '(bold)))
        (cons 'org-done (a (c 'green) nil '(bold)))
        (cons 'org-tag (a (c 'overlay1) nil))
        (cons 'org-priority (a (c 'red) nil '(bold)))
        (cons 'org-link (a (c 'blue) nil nil '(:underline t)))
        (cons 'org-footnote (a (c 'blue) nil nil '(:underline t)))
        (cons 'org-code (a (c 'overlay1) nil))
        (cons 'org-verbatim (a (c 'overlay1) nil))
        (cons 'org-block (a (c 'overlay1) nil))
        (cons 'org-block-begin-line (a (c 'overlay2) nil evergarden-style-comment))
        (cons 'org-block-end-line (a (c 'overlay2) nil evergarden-style-comment))
        (cons 'org-quote (a (c 'overlay2) nil evergarden-style-comment))
        (cons 'org-table (a (c 'subtext0) nil))
        (cons 'org-date (a (c 'skye) nil))
        (cons 'org-scheduled (a (c 'green) nil))
        (cons 'org-scheduled-today (a (c 'green) nil '(bold)))
        (cons 'org-scheduled-previously (a (c 'yellow) nil))
        (cons 'org-upcoming-deadline (a (c 'yellow) nil))
        (cons 'org-deadline (a (c 'red) nil))
        (cons 'org-warning (a (c 'yellow) nil '(bold)))
        (cons 'org-meta-line (a (c 'overlay2) nil evergarden-style-comment))
        (cons 'org-special-keyword (a (c 'overlay2) nil))
        (cons 'org-drawer (a (c 'overlay1) nil))
        (cons 'org-property-value (a (c 'subtext0) nil))
        (cons 'org-ellipsis (a (c 'overlay0) nil))
        (cons 'org-hide (a (c 'base) nil))
        (cons 'org-archived (a (c 'overlay0) nil))
        (cons 'org-checkbox (a nil nil '(bold)))
        (cons 'org-checkbox-statistics-todo (a (c 'red) nil '(bold)))
        (cons 'org-checkbox-statistics-done (a (c 'green) nil '(bold)))
        (cons 'org-agenda-structure (a (c 'cherry) nil '(bold)))
        (cons 'org-agenda-date (a (c 'skye) nil))
        (cons 'org-agenda-date-today (a accent nil '(bold)))
        (cons 'org-agenda-date-weekend (a (c 'overlay1) nil))
        (cons 'org-agenda-done (a (c 'green) nil))
        (cons 'org-agenda-dimmed-todo-face (a (c 'overlay0) nil))
        (cons 'org-agenda-current-time (a (c 'cherry) nil))
        (cons 'markdown-header-face (a (c 'cherry) nil '(bold)))
        (cons 'markdown-header-face-1 (a (c 'red) nil '(bold)))
        (cons 'markdown-header-face-2 (a (c 'orange) nil '(bold)))
        (cons 'markdown-header-face-3 (a (c 'yellow) nil '(bold)))
        (cons 'markdown-header-face-4 (a (c 'green) nil '(bold)))
        (cons 'markdown-header-face-5 (a (c 'aqua) nil '(bold)))
        (cons 'markdown-header-face-6 (a (c 'blue) nil '(bold)))
        (cons 'markdown-header-delimiter-face (a (c 'overlay2) nil))
        (cons 'markdown-bold-face (a (c 'aqua) nil '(bold)))
        (cons 'markdown-italic-face (a (c 'skye) nil '(italic)))
        (cons 'markdown-link-face (a (c 'blue) nil nil '(:underline t)))
        (cons 'markdown-url-face (a (c 'blue) nil nil '(:underline t)))
        (cons 'markdown-inline-code-face (a (c 'overlay1) nil))
        (cons 'markdown-code-face (a (c 'overlay1) nil))
        (cons 'markdown-pre-face (a (c 'overlay1) nil))
        (cons 'markdown-list-face (a (c 'overlay1) nil))
        (cons 'markdown-blockquote-face (a (c 'overlay2) nil evergarden-style-comment))
        (cons 'markdown-markup-face (a (c 'overlay1) nil))
        (cons 'markdown-language-keyword-face (a (c 'cherry) nil))
        (cons 'markdown-footnote-marker-face (a (c 'overlay1) nil))
        (cons 'markdown-metadata-key-face (a (c 'skye) nil))
        (cons 'markdown-metadata-value-face (a (c 'subtext0) nil))
        (cons 'markdown-table-face (a (c 'subtext0) nil))
        (cons 'markdown-hr-face (a (c 'overlay0) nil))
        (cons 'markdown-comment-face (a (c 'overlay2) nil evergarden-style-comment))
        (cons 'markdown-html-tag-name-face (a (c 'green) nil))
        (cons 'markdown-html-attr-name-face (a (c 'skye) nil))
        (cons 'markdown-html-attr-value-face (a (c 'lime) nil))
        (cons 'markdown-html-entity-face (a (c 'aqua) nil)))
       ...
       (list
        (cons 'diff-hl-insert (a (plist-get diff :add) sign))
        (cons 'diff-hl-change (a (plist-get diff :change) sign))
        (cons 'diff-hl-delete (a (plist-get diff :delete) sign))
        (cons 'diff-hl-unknown (a (c 'overlay0) sign))
        (cons 'git-gutter:added (a (plist-get diff :add) sign))
        (cons 'git-gutter:modified (a (plist-get diff :change) sign))
        (cons 'git-gutter:deleted (a (plist-get diff :delete) sign))
        (cons 'smerge-upper
              (a nil (evergarden--blend (plist-get diff :delete) (c 'base) 0.16)))
        (cons 'smerge-lower
              (a nil (evergarden--blend (plist-get diff :add) (c 'base) 0.16)))
        (cons 'smerge-base
              (a nil (evergarden--blend (plist-get diff :change) (c 'base) 0.16)))
        (cons 'smerge-markers (a (c 'overlay1) (c 'surface0)))
        (cons 'smerge-refined-added
              (a nil (evergarden--blend (plist-get diff :add) (c 'base) 0.32)))
        (cons 'smerge-refined-removed
              (a nil (evergarden--blend (plist-get diff :delete) (c 'base) 0.32)))
        (cons 'smerge-refined-changed
              (a nil (evergarden--blend (plist-get diff :change) (c 'base) 0.32)))
        (cons 'magit-branch-local (a (c 'skye) nil))
        (cons 'magit-branch-remote (a (c 'green) nil))
        (cons 'magit-branch-current (a accent nil nil '(:underline t)))
        (cons 'magit-tag (a (c 'yellow) nil))
        (cons 'magit-hash (a (c 'overlay1) nil))
        (cons 'magit-dimmed (a (c 'overlay1) nil))
        (cons 'magit-cherry-equivalent (a (c 'pink) nil))
        (cons 'magit-cherry-unmatched (a (c 'aqua) nil))
        (cons 'magit-keyword (a (c 'pink) nil))
        (cons 'magit-keyword-squash (a (c 'yellow) nil))
        (cons 'magit-log-author (a (c 'skye) nil))
        (cons 'magit-log-date (a (c 'overlay1) nil))
        (cons 'magit-section-heading (a (c 'cherry) nil '(bold)))
        (cons 'magit-section-heading-selection (a accent nil '(bold)))
        (cons 'magit-section-highlight (a nil (c 'surface0)))
        (cons 'magit-diff-file-heading (a (c 'text) nil '(bold)))
        (cons 'magit-diff-hunk-heading (a (c 'overlay1) (c 'surface0)))
        (cons 'magit-diff-hunk-heading-highlight (a (c 'subtext0) (c 'surface1)))
        ...
        (cons 'magit-diff-removed-highlight
              (a nil (evergarden--blend (plist-get diff :delete) (c 'base) 0.32)))
        (cons 'magit-diff-context (a (c 'overlay1) nil))
        (cons 'magit-diff-context-highlight (a (c 'subtext0) (c 'surface0)))
        (cons 'magit-process-ok (a (plist-get diag :ok) nil))
        (cons 'magit-process-ng (a (plist-get diag :error) nil)))

       ;; File trees and directories (nvimtree and neotree).
       (list
        (cons 'dired-directory (a (c 'overlay2) nil))
        (cons 'dired-header (a (c 'cherry) nil '(bold)))
        (cons 'dired-marked (a (c 'crust) accent '(bold)))
        (cons 'dired-flagged (a (plist-get diag :error) nil))
        (cons 'dired-symlink (a (c 'pink) nil))
        (cons 'dired-broken-link (a (plist-get diag :error) nil))
        (cons 'neo-dir-link-face (a (c 'overlay2) nil))
        (cons 'neo-file-link-face (a (c 'subtext1) nil))
        (cons 'neo-root-dir-face (a (c 'pink) nil '(bold)))
        (cons 'neo-header-face (a (c 'cherry) nil '(bold)))
        (cons 'neo-banner-face (a (c 'cherry) nil))
        (cons 'neo-button-face (a (c 'subtext0) nil))
        (cons 'neo-expand-btn-face (a (c 'overlay1) nil))
        (cons 'neo-vc-added-face (a (c 'blue) nil))
        (cons 'neo-vc-edited-face (a (c 'yellow) nil))
        (cons 'neo-vc-removed-face (a (plist-get diag :error) nil))
        (cons 'neo-vc-conflict-face (a (c 'red) nil '(bold)))
        (cons 'neo-vc-ignored-face (a (c 'overlay0) nil))
        (cons 'neo-vc-unregistered-face (a (c 'skye) nil))
        (cons 'neo-vc-up-to-date-face (a (c 'overlay1) nil))
        (cons 'treemacs-directory-face (a (c 'overlay2) nil))
        (cons 'treemacs-directory-collapsed-face (a (c 'overlay2) nil))
        (cons 'treemacs-file-face (a (c 'subtext1) nil))
        (cons 'treemacs-root-face (a (c 'pink) nil '(bold)))
        (cons 'treemacs-tags-face (a (c 'subtext0) nil))
        (cons 'treemacs-git-added-face (a (c 'blue) nil))
        (cons 'treemacs-git-modified-face (a (c 'yellow) nil))
        (cons 'treemacs-git-renamed-face (a (plist-get diag :error) nil))
        (cons 'treemacs-git-untracked-face (a (c 'skye) nil))
        (cons 'treemacs-git-ignored-face (a (c 'overlay0) nil))
        (cons 'treemacs-git-conflict-face (a (c 'red) nil '(bold)))
        (cons 'treemacs-git-unmodified-face (a (c 'subtext1) nil))
        (cons 'treemacs-git-commit-diff-face (a (c 'aqua) nil))
        (cons 'treemacs-marked-file-face (a (c 'crust) accent '(bold)))
        (cons 'treemacs-hl-line-face (a nil (c 'surface0)))
        (cons 'treemacs-window-background-face
              (a nil (unless evergarden-transparent-background (c 'base))))
        (cons 'treemacs-on-success-pulse-face (a nil (plist-get diag :ok)))
        (cons 'treemacs-on-failure-pulse-face (a nil (plist-get diag :error)))
        (cons 'treemacs-fringe-indicator-face (a (c 'overlay1) nil))
        (cons 'treemacs-async-loading-face (a (c 'overlay1) nil))
        (cons 'treemacs-header-button-face (a (c 'cherry) nil))
        (cons 'treemacs-help-title-face (a (c 'cherry) nil '(bold)))
        (cons 'treemacs-help-column-face (a (c 'subtext0) nil)))

       ;; which-key and rainbow-delimiters.
       (list
        (cons 'which-key-key-face (a (c 'text) nil))
        (cons 'which-key-separator-face (a (c 'overlay0) nil))
        (cons 'which-key-group-description-face (a (c 'subtext0) nil))
        (cons 'which-key-command-description-face (a (c 'subtext0) nil))
        (cons 'which-key-local-map-description-face (a (c 'subtext0) nil))
        (cons 'which-key-note-face (a (c 'overlay0) nil))
        (cons 'which-key-special-key-face (a accent nil '(bold)))
        (cons 'rainbow-delimiters-depth-1-face (a (c 'red) nil))
        (cons 'rainbow-delimiters-depth-2-face (a (c 'yellow) nil))
        (cons 'rainbow-delimiters-depth-3-face (a (c 'blue) nil))
        (cons 'rainbow-delimiters-depth-4-face (a (c 'orange) nil))
        (cons 'rainbow-delimiters-depth-5-face (a (c 'green) nil))
        (cons 'rainbow-delimiters-depth-6-face (a (c 'pink) nil))
        (cons 'rainbow-delimiters-depth-7-face (a (c 'aqua) nil))
        (cons 'rainbow-delimiters-depth-8-face (a (c 'purple) nil))
        (cons 'rainbow-delimiters-depth-9-face (a (c 'cherry) nil))
        (cons 'rainbow-delimiters-base-face (a (c 'text) nil))
        (cons 'rainbow-delimiters-base-error-face (a (c 'red) nil))
        (cons 'rainbow-delimiters-unmatched-face (a (c 'red) nil '(bold)))
        (cons 'rainbow-delimiters-mismatched-face (a (c 'red) nil '(bold)))
        ;; nvim's indent-blankline: surface0 guides, scope in green.
        (cons 'highlight-indent-guides-odd-face (a nil (c 'surface0)))
        (cons 'highlight-indent-guides-even-face (a nil (c 'surface0)))
        (cons 'highlight-indent-guides-character-face (a (c 'surface0) nil))
        (cons 'highlight-indent-guides-stack-character-face (a (c 'surface1) nil))
        (cons 'highlight-indent-guides-stack-odd-face (a nil (c 'surface1)))
        (cons 'highlight-indent-guides-stack-even-face (a nil (c 'surface1)))
        (cons 'highlight-indent-guides-top-character-face (a (c 'green) nil))
        (cons 'highlight-indent-guides-top-odd-face (a nil (c 'surface1)))
        (cons 'highlight-indent-guides-top-even-face (a nil (c 'surface1))))

       ;; Miscellaneous editing chrome.
       (list
        (cons 'match (a nil (c 'surface1)))
        (cons 'secondary-selection (a nil (c 'surface0)))
        (cons 'comint-highlight-prompt (a (c 'subtext0) nil))
        (cons 'compilation-error (a (plist-get diag :error) nil))
        (cons 'compilation-warning (a (plist-get diag :warn) nil))
        (cons 'compilation-info (a (plist-get diag :info) nil))
        (cons 'compilation-line-number (a (c 'overlay1) nil))
        (cons 'compilation-column-number (a (c 'overlay1) nil))
        (cons 'compilation-mode-line-exit (a (plist-get diag :ok) nil '(bold)))
        (cons 'compilation-mode-line-fail (a (plist-get diag :error) nil '(bold)))
        (cons 'compilation-mode-line-run (a (plist-get diag :warn) nil '(bold)))
        (cons 'trailing-whitespace
              (a nil (evergarden--blend (plist-get diag :error) (c 'base) 0.16)))
        (cons 'whitespace-tab (a (c 'surface1) nil))
        (cons 'whitespace-space (a (c 'surface1) nil))
       ...
       (list
        ...
        (cons 'doom-modeline-buffer-path (a (c 'subtext0) nil))
        (cons 'doom-modeline-buffer-major-mode (a (c 'green) nil))
        (cons 'doom-modeline-buffer-modified (a (c 'yellow) nil))
        (cons 'doom-modeline-buffer-minor-mode (a (c 'overlay1) nil))
        (cons 'doom-modeline-project-dir (a (c 'subtext0) nil))
        (cons 'doom-modeline-project-root-dir (a (c 'skye) nil))
        (cons 'doom-modeline-info (a (plist-get diag :ok) nil))
        (cons 'doom-modeline-warning (a (plist-get diag :warn) nil))
        (cons 'doom-modeline-error (a (plist-get diag :error) nil))
        (cons 'doom-modeline-urgent (a (plist-get diag :error) nil '(bold)))
        (cons 'doom-modeline-debug (a (c 'cherry) nil))
        (cons 'doom-modeline-notification (a (c 'blue) nil))
        (cons 'doom-modeline-evil-normal-state (a (c 'blue) nil '(bold)))
        (cons 'doom-modeline-evil-insert-state (a (c 'green) nil '(bold)))
        (cons 'doom-modeline-evil-visual-state (a (c 'yellow) nil '(bold)))
        (cons 'doom-modeline-evil-emacs-state (a (c 'purple) nil '(bold)))
        (cons 'doom-modeline-evil-motion-state (a (c 'purple) nil '(bold)))
        (cons 'doom-modeline-evil-operator-state (a (c 'blue) nil '(bold))))
